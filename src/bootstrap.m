function [meanAcc, lower, upper] = bootstrap(feat_test,net)
    % nboot = round(height(feat_test)/10);
    nboot = 100;
    ...
    for i = 1:nboot
        ...
        sim_result = simulateTest_1step(selectedData,net);
...
function result = simulateTest_1step(data,net)
    predicted = classify(net,data);
